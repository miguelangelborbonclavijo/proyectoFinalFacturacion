            ...
            <tbody>
                ...
                while ($filas = mysqli_fetch_array($resulproductos)) { ?>
                    <tr style="text-align: center;">
                        ...
                        <td>
                            <a href="../registro_trabajador/editar_trabajador.php?id=<?php echo $filas['TraPerId'] ?>">
                            ...
                            <a href="../registro_trabajador/eliminar_trabajador.php?id=<?php echo $filas['TraPerId'] ?>">
