<section class="p-5 bg-primary">
    <div class="container py-5">
        ...
        <p class="lead text-center text-light mb-5">
            Responsables de la elaboracion del proyecto FacElec demostrando sus conocimiento adquirido en el SENA, para su formacion academica y profesional. En la cual se muestra la la informacion de ellos, sus redes sociales y hoja de vida.
        </p>
        <div class="row g-4">
