        ...
        <div class="row text-center g-4">
            ...
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../inventario/entradas.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Salida</h3>
                    ...
                    <a href="../inventario/salidas.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
