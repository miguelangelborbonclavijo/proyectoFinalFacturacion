    ...
    <table class="table">
      <thead>
        ...
        <tr style="text-align: center;">
          <th scope="col">CODIGO DE REPORTE</th>
      ...
      <tbody>
        <?php
        $query = "SELECT * FROM reporte_productos";
        $resulproductos = mysqli_query($conn, $query);
        while ($filas = mysqli_fetch_array($resulproductos)) { ?>
          <tr style="text-align: center;">
            <td><?php echo $filas['repId'] ?></td>
            <td><?php echo $filas['RepProId'] ?></td>
            <td><?php echo $filas['DesRePr'] ?></td>
            <td><?php echo $filas['RepFech'] ?></td>
            <td>
              <a href="../../inventario/reporte_productos/editar_reporte_productos.php ?id=<?php echo $filas['repId'] ?>">
              ...
              <a href="../../inventario/reporte_productos/eliminar_productos.php?id=<?php echo $filas['repId'] ?>">
