<?php include("../../vistas/includes/headtra.php") ?>
        ...
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../../proyectoFinalFacturacion/vistas/registros/registro_personas/registro_personas.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../../proyectoFinalFacturacion/vistas/Trabajadores/registros/registro_soporte/registro_soportes.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Registrar Trabajadores</h3>
                    <p style="height:50%;" class="card-text">
                        En Este apartado podras registrar a todos los usuarios que interactuan con el sistema.
                    </p>
        ...
        <div class="row text-center g-4">
            ...
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../Trabajadores/inventario/ele_crepro.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../Trabajadores/compras/tip_compras.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
