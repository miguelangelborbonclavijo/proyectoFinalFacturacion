      ...
      <tbody>
        ...
        while ($filas = mysqli_fetch_array($resulproductos)) { ?>
          <tr style="text-align: center;">
            ...
            <td>
              <a href="../../registros/registro_personas/editar_personas.php?id=<?php echo $filas['PerId'] ?>">
              ...
              <a href="../../registros/registro_personas/eliminar_persona.php ?id=<?php echo $filas['PerId'] ?>">
