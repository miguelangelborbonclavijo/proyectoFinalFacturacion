...
<form action="../registros/editar_tipo_producto.php?id=<?php echo $_GET['id']; ?>" method="POST" style="width: 60%; margin-left: 20%" class="forCont row g-1">
<table>
...
<tr>
<td></td>
<td style="width: 200px; text-align: center"><p><strong>DATOS DEL TIPO DE PRODUCTO</strong></p></td>
<td></td>
</tr>
</table>
<table>
