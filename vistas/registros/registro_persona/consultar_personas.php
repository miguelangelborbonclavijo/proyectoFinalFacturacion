      ...
      <tbody>
        ...
        while ($filas = mysqli_fetch_array($resulproductos)) { ?>
          <tr style="text-align: center;">
            ...
            <td><?php echo $filas['PerCor'] ?></td>
            <td>
              <a href="../registro_persona/editar_personas.php?id=<?php echo $filas['PerId'] ?>">
              ...
              <a href="../registro_persona/eliminar_persona.php?id=<?php echo $filas['PerId'] ?>">
