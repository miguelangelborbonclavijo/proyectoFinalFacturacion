    ...
    <section class="bg-dark text-light p-5 text-center text-sm-start" id="home">
        <div class="container py-5">
            <div class="d-sm-flex align-item-center">
                ...
                <div>
                    <form action="../login/consulta_login.php" method="POST">
                        <h1>Bienvenidos a FacElec</h1>
                        <h3 class="my-4">Inicio Session<br>Cliente</h3>
                        ...
                        <a href="../inicio_usuarios/homecli.php">ir</a>
                        <button type="submit" class="btn btn-primary" name="conflogcli">Ingresar</button>
                    </form>
                </div>
            </div>
        </div>
