        ...
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Tipo de Productos</h3>
                    <p style="height:50%;" class="card-text">
                        En Este apartado podras registrar a todos los usuarios que interactuan con el sistema.
                    </p>
                    <a href="../../../proyectoFinalFacturacion/vistas/inventario/registro_tipo_productos/registro_tipo_producto.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../../proyectoFinalFacturacion/vistas/inventario/registro_producto/registro_productos.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
