...
<a href="../../../../vistas/Trabajadores/inventario/registro_producto/registro_productos.php" class="btn btn-primary">Regresar</a>
            ...
            <tbody>
                ...
                while ($filas = mysqli_fetch_array($resulproductos)) { ?>
                    <tr style="text-align: center;">
                        ...
                        <td>
                            <a href="../registro_producto/editar_productos.php?id=<?php echo $filas['ProId'] ?>">
                            ...
                            <a href="../registro_producto/eliminar_productos.php?id=<?php echo $filas['ProId'] ?>">
