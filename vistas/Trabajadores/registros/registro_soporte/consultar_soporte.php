    ...
    <table class="table">
      <thead>
        ...
        <tr style="text-align: center;">
          ...
          <th scope="col">TIPO DE CLIENTES</th>
      ...
      <tbody>
        ...
        while ($filas = mysqli_fetch_array($resulproductos)) { ?>
          <tr style="text-align: center;">
            ...
            <td>
              <a href="../registro_soporte/eliminar_soporte.php ?id=<?php echo $filas['SopDoCl'] ?>">
              ...
              <!--<a href="../../registros/registro_personas/eliminar_persona.php ?id=<?php echo $filas['SopDoCl'] ?>">
