    ...
    <table>
      ...
      <div class="col-md-6 position-relative">
        ...
        <div class="input-group has-validation">
          ...
          <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="CorrCli" required>
      ...
      <table>
        ...
        <table>
          <tr>
            ...
            <div class="esp col-3">
              <a href="../../../../proyectoFinalFacturacion/vistas/registros/registro_personas/consultar_personas.php" class="btn btn-primary">Consultar personas</a>
            </div>
          </tr>
        </table>
      </table>
