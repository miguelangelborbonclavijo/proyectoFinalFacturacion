...
<a href="../../../../vistas/inicio_usuarios/hometra.php" class="btn btn-primary">Regresar</a>
        ...
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../../../proyectoFinalFacturacion//vistas//Trabajadores/compras/registro_proveedores/registro_proveedor.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../../../proyectoFinalFacturacion/vistas/Trabajadores/compras/entradas.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
