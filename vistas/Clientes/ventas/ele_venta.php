...
<a href="../../../../proyectoFinalFacturacion/vistas/inicio_usuarios/homecli.php" class="btn btn-primary">Regresar</a>
        ...
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">CODIGO VENTA</h3>
                    <p style="height:50%;" class="card-text">
                        En Este apartado podras registrar a todos los usuarios que interactuan con el sistema.
                    </p>
                    <a href="../../Clientes/ventas/codigo_ventas/cod_venta.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../ventas/registrar_ventas/salidas.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
