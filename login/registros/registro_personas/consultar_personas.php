...
<a href="../../../login/registros/registro_personas/registro_personas.php" class="btn btn-primary">Regresar</a>
  <div class="container-lg">
    <table class="table">
      <thead>
        <tr>
          <h1 style="text-align: center;">PERSONAS REGISTRADOS</h1>
          <br>
        </tr>
      ...
      <tbody>
        ...
        while ($filas = mysqli_fetch_array($resulproductos)) { ?>
          <tr style="text-align: center;">
            ...
            <td><?php echo $filas['PerTipUs'] ?></td>
            <td><?php echo $filas['PerNom1'] ?></td>
            <td><?php echo $filas['PerNom2'] ?></td>
            <td><?php echo $filas['PerApe1'] ?></td>
            <td><?php echo $filas['PerApe2'] ?></td>
            <td><?php echo $filas['PerDirr'] ?></td>
            <td><?php echo $filas['PerFech'] ?></td>
            <td>
              <a href="../../../login/registros/registro_personas/editar_personas.php?id=<?php echo $filas['PerId'] ?>">
              ...
              <a href="../../../login/registros/registro_personas/eliminar_persona.php?id=<?php echo $filas['PerId'] ?>">
