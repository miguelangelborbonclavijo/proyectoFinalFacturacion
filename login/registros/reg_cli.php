        ...
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Registro Personas <br> Paso 1</h3>
                    <p style="height:50%;" class="card-text">
                        En Este apartado podras registrar a todos los usuarios que interactuan con el sistema.
                    </p>
                    <a href="../../login/registros/registro_personas/registro_personas.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Registrar Clientes <br> Paso  2</h3>
                    <p style="height:50%;" class="card-text">
                        En este apartado podras registrar todas las vantas de los productos o servicios que se hicieron en la empresa.
                    </p>
                    <a href="../../login/registros/registro_clientes/registro_clientes.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Registrar Cuenta <br> Paso 3</h3>
                    ...
                    <a href="../../login/registros/registro_usuario/registro_usuario.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
