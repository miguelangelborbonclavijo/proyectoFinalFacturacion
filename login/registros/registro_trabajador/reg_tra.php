        ...
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Registro Trabajadores <br> Paso 1</h3>
                    <p style="height:50%;" class="card-text">
                        En Este apartado podras registrar a todos los usuarios que interactuan con el sistema.
                    </p>
                    <a href="../../../login/registros/registro_trabajador/registro_trabajador.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Registrar Cuenta <br> Paso 2</h3>
