...
<?php
    ...
    if(isset($_POST['actualizar_tipProveedor'])){
        ...
        $TipDirrP = $_POST['Dirr'];
        $numCel = $_POST['NumCel'];
        $query = "UPDATE proveedores set PrNomPr = '$TipNomProv', PrCel = '$numCel', PrDirr = '$TipDirrP' WHERE PrId = $id";
        mysqli_query($conn, $query);
    }
?>
<a href="../../../login/inicio/registro_proveedores/consultar_proveedores.php" class="btn btn-primary">Regresar</a>
    ...
    <table>
        ...
        <div class="col-md-6 position-relative">
            ...
            <input type="text" class="form-control" id="validationTooltip01" name="NumCel" required  value="<?php echo $Cel?>">
            <div class="valid-tooltip">
            Documento valido...!
            </div>
            <div class="invalid-tooltip">
