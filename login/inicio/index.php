    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://www.nosolopymes.com/imagenes/7-ideas-para-promocionar-tu-negocio.jpg" class="inline-flex w-60" alt="...">
...
<section class="p-5" id="services">
    <div class="container py-5">
        <h2 class="text-center mb-4">Unete a Nosotros</h2>
        <br>
        <div class="row text-center g-4">
            ...
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../login/inicio/registro_proveedores/registro_proveedor.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
</section>
<section class="bg-primary text-light p-5" id="learn">
    <div class="container py-5">
        <div class="row align-items-cente justify-content-between">
            <div class="col-md p-5">
                ...
                <a class="text-light" href="http://">Nuestras Ventajas</a>
            </div>
            <div class="col-md">
                <a href=""></a>
...
<section class="p-5" id="services">
    <div class="container py-5">
        <h2 class="text-center mb-4">ERROR 404 Y 500</h2>
        <br>
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Error 404</h3>
                    <p style="height:50%;" class="card-text">
                        En Este apartado podras registrar a todos los usuarios que interactuan con el sistema.
                    </p>
                    <a href="../errores/error404/error404.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <h3 class="card-title mb-4">Error 500</h3>
                    <p style="height:50%;" class="card-text">
                        En este apartado podras registrar todas las vantas de los productos o servicios que se hicieron en la empresa.
                    </p>
                    <a href="../errores/error500/error500.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
