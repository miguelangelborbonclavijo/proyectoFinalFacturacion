        ...
        <div class="row text-center g-4">
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../../login/ventas/codigo_ventas/cod_venta.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
            <div class="col-md">
                <div style="height:100%;" class="card bg-dark text-light p-5">
                    ...
                    <a href="../../../login/compras/ventas/salidas.php" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
        </div>
    </div>
