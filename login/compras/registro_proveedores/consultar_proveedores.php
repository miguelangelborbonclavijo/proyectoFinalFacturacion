...
<a href="../../../login/compras/registro_proveedores/registro_proveedor.php" class="btn btn-primary">Regresar</a>
                ...
                while ($filas = mysqli_fetch_array($resulproductos)) { ?>
                    <tr style="text-align: center;">
                        ...
                        <td>
                            ...
                            <a href="../registro_proveedores/eliminar_proveedores.php?id=<?php echo $filas['PrId'] ?>">
